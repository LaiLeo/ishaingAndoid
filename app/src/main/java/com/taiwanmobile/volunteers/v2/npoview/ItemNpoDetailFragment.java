...
public class ItemNpoDetailFragment extends SupportFragment implements OnClickListener {
	final String TAG = getClass().getSimpleName();

	private long mNpoId;
	public static ItemNpoDetailFragment npoObj;

	private Cursor mCursor;
	private NpoDAO mNpoObject;

	public ItemNpoDetailFragment setNpoId(long id) {
		mNpoId = id;
		npoObj = this;
