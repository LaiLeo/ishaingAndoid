...
public class SubscribeNPOTask extends AsyncTaskWithDialogs<Void, Void>
	...
	public SubscribeNPOTask(Context c, long id, Button b) {
		super(c);
		mContext = c;
		mNpoId = id;
		mButton = b;
		url = BackendContract.V2_NPO_SUBSCRIBE_URL + mNpoId + "/";
		setProgressDialog(DialogFactory.createBusyDialog(mContext, "訂閱NPO中"));
			...
			TransactionManager.callInTransaction(
					...
					new Callable<Void>() {
						...
						public Void call() throws Exception {
							new SubscribedNpoDAO(new JSONObject(responseString))
									.save();
							return null;
						}
					});
	...
	public void onDismiss(DialogInterface arg0) {
		if (returnStatusCode == 200) {
			...
			new DialogFactory.TitleMessageDialog(mContext, "訂閱失敗",
					"請確認手機上網功能已開啟").show();
		}
	}
}
