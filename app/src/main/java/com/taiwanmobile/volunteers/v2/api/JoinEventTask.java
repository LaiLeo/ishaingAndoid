...
//
//public class JoinEventTask extends AsyncTaskWithDialogs<Void, Void> implements
//		OnDismissListener {
...
//
//	public JoinEventTask(Context c, Fragment pFrag, String uid) {
//		super(c);
//		mContext = c;
//		mEventDetailFragment = pFrag;
//		eventUid = uid;
//		url = BackendContract.V2_EVENT_JOIN_URL + eventUid + "/";
